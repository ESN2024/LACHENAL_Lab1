...
`timescale 1 ps / 1 ps
module ga_lab1_mm_interconnect_0 (
	...
	wire  [93:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_data_master_agent:rp_data
	...
	wire  [93:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	...
	wire  [94:0] pio_0_s1_agent_rf_source_data;                                                      // pio_0_s1_agent:rf_source_data -> pio_0_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_0_s1_agent_rsp_fifo_out_data;                                                   // pio_0_s1_agent_rsp_fifo:out_data -> pio_0_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [94:0] pio_1_s1_agent_rf_source_data;                                                      // pio_1_s1_agent:rf_source_data -> pio_1_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_1_s1_agent_rsp_fifo_out_data;                                                   // pio_1_s1_agent_rsp_fifo:out_data -> pio_1_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_1_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [94:0] pio_2_s1_agent_rf_source_data;                                                      // pio_2_s1_agent:rf_source_data -> pio_2_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_2_s1_agent_rsp_fifo_out_data;                                                   // pio_2_s1_agent_rsp_fifo:out_data -> pio_2_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_2_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [93:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pio_2_s1_agent_rp_valid;                                                            // pio_2_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_007:sink_data
	wire         pio_2_s1_agent_rp_ready;                                                            // router_007:sink_ready -> pio_2_s1_agent:rp_ready
	wire         pio_2_s1_agent_rp_startofpacket;                                                    // pio_2_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_2_s1_agent_rp_endofpacket;                                                      // pio_2_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	ga_lab1_mm_interconnect_0_router router (
	...
	ga_lab1_mm_interconnect_0_router_001 router_001 (
	...
	ga_lab1_mm_interconnect_0_router_002 router_002 (
	...
	ga_lab1_mm_interconnect_0_router_003 router_003 (
	...
	ga_lab1_mm_interconnect_0_router_003 router_004 (
	...
	ga_lab1_mm_interconnect_0_router_002 router_005 (
	...
	ga_lab1_mm_interconnect_0_router_002 router_006 (
	...
	ga_lab1_mm_interconnect_0_router_002 router_007 (
	...
	ga_lab1_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ga_lab1_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
